...
export declare function getItemStyles<TNodeDatum, TStyle>(getItemStyle: (nodeDatum: TNodeDatum | undefined, isHighlight: boolean, highlightState?: HighlightState) => TStyle): Record<HighlightState, TStyle>;
...
export declare function findNodeDatumInArray<D extends SeriesNodeDatum<DatumIndexType>>(itemIdOrIndex: AgActiveItemState['itemId'], nodeData: D[] | undefined): D | undefined;
