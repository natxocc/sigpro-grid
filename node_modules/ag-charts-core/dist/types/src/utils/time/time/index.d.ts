...
export { intervalFloor, intervalCeil, intervalPrevious, intervalNext, intervalExtent, intervalRangeCount, intervalRange, intervalRangeNumeric, intervalRangeStartIndex, decodeIntervalValue, encodedToTimestamp, } from './range';
