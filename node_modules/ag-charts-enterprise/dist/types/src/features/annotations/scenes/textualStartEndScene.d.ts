...
export declare abstract class TextualStartEndScene<Datum extends TextualStartEndProperties> extends StartEndScene<Datum> {
    ...
    protected getTextBBox(datum: Datum, coords: Bounds4): _ModuleSupport.BBox;
    protected updateLabel(datum: Datum, bbox: _ModuleSupport.BBox, coords: Bounds4): void;
    protected updateShape(_datum: Datum, _textBBox: _ModuleSupport.BBox, _coords: Bounds4): void;
