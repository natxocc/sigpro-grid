...
import { type FontOptions, type Point } from 'ag-charts-core';
...
export declare function maybeWrapText(options: TextOptions, text: string, maxWidth: number): string;
export declare function getBBox(options: TextOptions & {
    width?: number;
}, text: string, coords: Point, bbox?: _ModuleSupport.BBox): _ModuleSupport.BBox;
...
}, { x, y }: Point, textBaseline?: CanvasTextBaseline): void;
export {};
