...
export declare class RadarAreaSeries extends RadarSeries<S, O, P> {
    ...
    protected makeStylerParams(highlightStateEnum?: _ModuleSupport.HighlightState): AgRadarAreaSeriesStylerParams;
    getStyle(highlightState?: _ModuleSupport.HighlightState): ResolvedRadarStyle<AgRadarAreaSeriesStyle>;
}
export {};
