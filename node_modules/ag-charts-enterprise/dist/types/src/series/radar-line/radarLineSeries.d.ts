...
export declare class RadarLineSeries extends RadarSeries<S, O, P> {
    ...
    protected makeStylerParams(highlightStateEnum?: _ModuleSupport.HighlightState): AgRadarLineSeriesStylerParams;
    getStyle(highlightState?: _ModuleSupport.HighlightState): ResolvedRadarStyle<AgRadarLineSeriesStyle>;
}
export {};
