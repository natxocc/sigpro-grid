...
import type { AgChartLabelFormatterParams, AgGradientColorMode, AgRadialGaugeLabelFormatterParams, AgRadialGaugeMarkerShape, AgRadialGaugeOptions, AgRadialGaugeSeriesStyle, AgRadialGaugeTargetPlacement, AgRadialGaugeTooltipRendererParams, FontStyle, FontWeight } from 'ag-charts-types';
...
declare const SeriesProperties: typeof _ModuleSupport.SeriesProperties, AxisLabel: typeof _ModuleSupport.AxisLabel, Label: typeof _ModuleSupport.Label;
...
export type RadialGaugeLabelDatum = {
    ...
    fontFamily: string;
    lineHeight: number | undefined;
    formatter: RichFormatter<AgChartLabelFormatterParams<any> & RequireOptional<AgRadialGaugeLabelFormatterParams>> | undefined;
};
...
export declare class RadialGaugeSeriesProperties extends SeriesProperties<AgRadialGaugeOptions> {
    ...
    targets: PropertiesArray<RadialGaugeTargetProperties>;
