import type { AgChartThemeOverrides, AgPolarAxisOptions, AgPolarChartOptions, AgPolarSeriesOptions } from 'ag-charts-types';
...
export declare class PolarChartProxy extends ChartProxy<AgPolarChartOptions, 'radar-line' | 'radar-area' | 'nightingale' | 'radial-column' | 'radial-bar'> {
    getAxes(_: UpdateParams): Record<string, AgPolarAxisOptions>;
    ...
    protected getSeriesChartThemeDefaults(): AgChartThemeOverrides['radar-line' | 'radar-area' | 'nightingale' | 'radial-column' | 'radial-bar'];
}
