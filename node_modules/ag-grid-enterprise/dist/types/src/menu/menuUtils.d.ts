...
export declare class MenuUtils extends BeanStub implements NamedBean {
    ...
    closePopupAndRestoreFocusOnSelect(hidePopupFunc: (popupParams?: PopupEventParams) => void, restoreFocusParams: MenuRestoreFocusParams, event?: AgCloseMenuEvent): void;
